...
1. [Introduction](cleancode.md#introduction)
2. [Variables](cleancode.md#variables)
3. [Functions](cleancode.md#functions)
4. [Objects and Data Structures](cleancode.md#objects-and-data-structures)
5. [Classes](cleancode.md#classes)
   1. [S: Single Responsibility Principle \(SRP\)](cleancode.md#single-responsibility-principle-srp)
   2. [O: Open/Closed Principle \(OCP\)](cleancode.md#openclosed-principle-ocp)
   3. [L: Liskov Substitution Principle \(LSP\)](cleancode.md#liskov-substitution-principle-lsp)
   4. [I: Interface Segregation Principle \(ISP\)](cleancode.md#interface-segregation-principle-isp)
   5. [D: Dependency Inversion Principle \(DIP\)](cleancode.md#dependency-inversion-principle-dip)
...
[**⬆ back to top**](cleancode.md#table-of-contents)
